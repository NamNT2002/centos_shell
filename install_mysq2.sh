...
#MySQL, RabbitMQ, NTP
echo "export dbpass=`openssl rand -hex 32`"
echo "export dbp_keystone=`openssl rand -hex 32`"
echo "export dbp_glance=`openssl rand -hex 32`"
dbp_neutron=`openssl rand -hex 32`
