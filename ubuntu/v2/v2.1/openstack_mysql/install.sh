...
#Controller
dir=`pwd`
touch $dir/openstack_configure
chmod +x $dir/openstack_configure
sh $dir/create_passdb
sh $dir/create_admin
source $dir/openstack_configure
...
DROP TABLE IF EXISTS configure_openstack;
